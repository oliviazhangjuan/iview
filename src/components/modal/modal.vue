          ...
          <div :class="[prefixCls + '-content']">
            ...
            <div :class="[prefixCls + '-footer']" v-if="!footerHide">
              <slot name="footer">
                ...
                <i-button type="primary" size="large" :loading="buttonLoading" @click.native="ok">{{ localeOkText }}
                </i-button>
              </slot>
            </div>
          </div>
...
<script>
  ...
  export default {
    ...
    watch: {
      ...
      visible (val) {
        if (val === false) {
          this.$emit('on-hide'); // modal展示之前调用on-show方法 // jason
          ...
          this.$emit('on-show');// modal展示之后调用on-hide方法
          this.wrapShow = true;
          if (!this.scrollable) {
